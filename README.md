...
python scripts/stage_a_prepare_gplpr.py \
  ...
  --split-dir ./manifests/splits/scenario_b_dev_seed42_n1000_v20 \
...
python scripts/stage_a_eval_gplpr.py \
  ...
  --stage-dir ./external_data/gplpr_stage \
  --output-dir ./outputs/stage_a \
  --checkpoint ./outputs/stage_a/checkpoints/stage_a_scenario_b_dev_seed42_n1000_v20/best_model.pth
```
